...
export default {
  ...
  preparation: {
    ...
    steps: [
    {
      title: { zh: '预订平台', en: 'Step 1', ru: 'Ctrip, Meituan, Booking.com' },
      desc: {
        zh: '🏨 预订平台\n• 携程：最大最全\n• 美团酒店：性价比高\n• 飞猪（阿里）：常有优惠\n• Booking.com：国际连锁酒店',
    ...
    {
      title: { zh: '价格参考', en: 'Economy ¥100-300, Mid ¥300-600, High ¥600-2000', ru: 'Эконом 100-300 ¥, средний 300-600 ¥' },
      desc: {
        zh: '💰 价格参考\n• 经济型（如家/汉庭）：100-300元\n• 中档（全季/亚朵）：300-600元\n• 高档（希尔顿/万豪）：600-2000元\n\n⚠️ 外国人住宿注意\n• 不是所有酒店都能接待外国人\n• 搜索时筛选"接待外宾"\n• 入住需出示护照\n• 酒店需登记外国人住宿信息\n• 民宿（Airbnb类）可能无法登记',
        en: '💰 Economy ¥100-300, Mid ¥300-600, High ¥600-2000\n⚠️ Not all hotels accept foreigners — filter "接待外宾"; passport required; B&Bs may not register foreigners',
        ru: '💰 Эконом 100-300 ¥, средний 300-600 ¥\n⚠️ Не все отели принимают иностранцев — ищите "接待外宾"'
      }
    },
    {
      title: { zh: '青年旅舍（YHA）是省钱好选择，也是认识旅行者的机会。', en: 'Step 3', ru: 'Хостелы YHA — бюджетно' },
      desc: {
        zh: '💡 青年旅舍（YHA）是省钱好选择，也是认识旅行者的机会。',
        en: '💡 YHA hostels are budget-friendly and great for meeting travelers',
        ru: '💡 Хостелы YHA — бюджетно'
      }
    }
  ],
  faq: [
