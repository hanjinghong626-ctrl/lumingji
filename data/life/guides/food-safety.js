...
export default {
  ...
  preparation: { zh: [], en: [], ru: [] },
    steps: [
    {
      title: { zh: '💧 饮水', en: 'Step 1', ru: 'Вода: не пейте из-под крана, кипятите или покупайте' },
      desc: {
        zh: '💧 饮水：\n• 自来水不建议直饮，烧开后饮用\n• 购买瓶装水（农夫山泉、怡宝等）\n• 餐厅提供的冰水也要注意\n\n🦐 食物过敏：\n• 中国菜可能含花生、芝麻等常见过敏原\n• 点餐时明确告知过敏原\n• 出示文字：「我对XX过敏」（Wǒ duì XX guòmǐn）\n\n🤢 食物中毒应对：\n1. 停止进食\n2. 多喝水\n3. 症状严重时去医院急诊\n4. 保留食物样本（如有）\n5. 拨打120急救电话',
        en: '💧 Water: don\'t drink tap water directly; boil or buy bottled (Nongfu Spring, C\'estbon)\n\n🦐 Allergies: Chinese food may contain peanuts, sesame — tell staff: "我对XX过敏" (I\'m allergic to XX)\n\n🤢 Food poisoning: stop eating → drink water → severe cases: hospital ER → keep food sample → call 120',
        ru: '💧 Вода: не пейте из-под крана, кипятите или покупайте\n🦐 Аллергии: скажите "我对XX过敏" (аллергия на XX)\n🤢 Отравление: прекратите есть → вода → при тяжёлом: больница → 120'
      }
    },
    {
      title: { zh: '适应期：初到中国前1-2周，肠胃可能需要适应，选择清淡饮食', en: 'Step 2', ru: 'Первые 1-2 недели: лёгкая пища для адаптации' },
      desc: {
        zh: '💡 适应期：初到中国前1-2周，肠胃可能需要适应，选择清淡饮食',
        en: '💡 Adjustment: first 1-2 weeks, eat light to let your stomach adapt',
        ru: '💡 Первые 1-2 недели: лёгкая пища для адаптации'
      }
    }
  ],
  faq: [
