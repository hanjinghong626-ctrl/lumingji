...
export default {
  ...
  steps: [
    {
      title: { zh: '兼职规定与个税', en: 'Work Rules & Tax', ru: 'Правила работы и налог' },
      desc: { zh: '⚠️ 兼职前提：\n• X1签证 + 居留许可\n• 学校同意并备案\n• 公安机关兼职许可\n• 未经批准的兼职属违法行为\n\n📊 个税计算：\n• 起征点：5000元/月\n• 劳务报酬：每次≤4000元扣800，>4000元扣20%，税率20%\n\n💡 年度汇算：每年3-6月通过「个人所得税」App申报，多缴可退。', en: '⚠️ Requirements:\n• X1 visa + residence permit\n• University approval\n• Police work permission\n• Unauthorized work is illegal\n\n📊 Tax calculation:\n• Threshold: ¥5,000/month\n• Service income: deduct ¥800 (≤¥4,000) or 20% (>¥4,000), rate 20%\n\n💡 Annual reconciliation: March-June via "个人所得税" app. Overpaid can be refunded.', ru: '⚠️ Требования:\n• Виза X1 + ВНЖ\n• Разрешение вуза\n• Разрешение полиции\n• Нелегальная работа — нарушение\n\n📊 Налог: порог 5000 ¥/мес, ставка 20%\n💡 Годовая декларация: март-июнь, переплата возвращается.' },
    },
  ],
  faq: [
