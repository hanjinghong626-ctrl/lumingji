...
export default {
  ...
  preparation: { zh: ['护照', '录取通知书', 'JW201/JW202表'], en: ['Passport', 'Admission letter', 'JW201/JW202 form'], ru: ['Паспорт', 'Письмо о зачислении', 'Форма JW201/JW202'] },
    steps: [
    {
      title: { zh: '常见签证类型', en: 'Common types', ru: 'Типы' },
      desc: {
        zh: '📋 常见签证类型：',
        en: '📋 Common types:',
        ru: '📋 Типы:'
    ...
    {
      title: { zh: 'X1签证（长期学习）', en: 'Step 2', ru: 'X1 (>180 дней, ВНЖ за 30 дней, для студентов)' },
      desc: {
        zh: '🎓 X1签证（长期学习）：\n• 停留>180天\n• 入境后30天内须办理居留许可\n• 适用于学历生',
        en: '🎓 X1 (long-term study): >180 days, must get residence permit within 30 days of entry, for degree students',
        ru: '🎓 X1 (>180 дней, ВНЖ за 30 дней, для студентов)'
      }
    },
    {
      title: { zh: 'X2签证（短期学习）', en: 'Others: L (tourist), Z (work), Q (family), M (business)', ru: 'X2 (≤180 дней, без ВНЖ)' },
      desc: {
        zh: '🎓 X2签证（短期学习）：\n• 停留≤180天\n• 无需办理居留许可\n• 适用于短期进修/交换\n\n其他签证：\n• L签：旅游\n• Z签：工作\n• Q签：家庭团聚\n• M签：商务',
        en: '🎓 X2 (short-term): ≤180 days, no residence permit needed, for exchange/short courses\n\nOthers: L (tourist), Z (work), Q (family), M (business)',
        ru: '🎓 X2 (≤180 дней, без ВНЖ)\nДругие: L (туризм), Z (работа), Q (семья), M (бизнес)'
      }
    },
    {
      title: { zh: '留学生通常持X1签证入境，然后办理居留许可。', en: 'Students usually enter on X1, then get residence permit.', ru: 'Студенты въезжают по X1, затем ВНЖ.' },
      desc: {
        zh: '💡 留学生通常持X1签证入境，然后办理居留许可。',
        en: '💡 Students usually enter on X1, then get residence permit.',
        ru: '💡 Студенты въезжают по X1, затем ВНЖ.'
      }
    }
  ],
  faq: [
