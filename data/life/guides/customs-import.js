...
export default {
  ...
  preparation: {
    ...
    steps: [
    {
      title: { zh: '国际包裹须知', en: 'Step 1', ru: 'Лимит: 800-1000 ¥, свыше — пошлина 13-50%' },
      desc: {
    ...
    {
      title: { zh: '给留学生的建议', en: 'Step 2', ru: 'Не превышайте лимит стоимости посылки' },
      desc: {
        zh: '💡 给留学生的建议：\n• 从国内寄东西到学校，注意单包价值不要超标\n• 家人寄来的个人物品通常不会被税\n• 贵重物品建议随身携带而非邮寄',
        en: '💡 Keep single package value under threshold; personal items from family usually not taxed',
        ru: '💡 Не превышайте лимит стоимости посылки'
      }
    }
  ],
  faq: [
