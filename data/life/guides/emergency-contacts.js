...
export default {
  ...
  preparation: { zh: ['保存到手机通讯录'], en: ['Save to phone contacts'], ru: ['Сохраните в контакты телефона'] },
    steps: [
    {
      title: { zh: '通用紧急电话', en: 'Emergency numbers', ru: 'Экстренные' },
      desc: {
        zh: '🆘 通用紧急电话：\n• 报警：110\n• 急救：120\n• 火警：119\n• 交通事故：122',
    ...
    {
      title: { zh: '服务热线', en: 'Service hotlines', ru: 'Сервисы: 12345 (жалобы), 12348 (юридическая), 12315 (потребители)' },
      desc: {
        zh: '📞 服务热线：\n• 12345：市民服务热线（综合投诉）\n• 12348：法律援助热线\n• 12315：消费者投诉\n• 12320：卫生热线',
        en: '📞 Service hotlines:\n• 12345: citizen hotline (complaints)\n• 12348: legal aid\n• 12315: consumer complaints\n• 12320: health hotline',
        ru: '📞 Сервисы: 12345 (жалобы), 12348 (юридическая), 12315 (потребители)'
      }
    },
    {
      title: { zh: '领事保护', en: 'Step 3', ru: 'Консульство: +86-10-12308' },
      desc: {
        zh: '🌐 领事保护：\n• 外交部全球领事保护热线：+86-10-12308\n• 联系你所在国家的大使馆/领事馆',
        en: '🌐 Consular: MFA global hotline +86-10-12308, contact your embassy',
        ru: '🌐 Консульство: +86-10-12308'
      }
    },
    {
      title: { zh: '拨打紧急电话免费，无需区号，任何电话均可拨打。', en: 'Step 4', ru: 'Бесплатно с любого телефона.' },
      desc: {
        zh: '💡 拨打紧急电话免费，无需区号，任何电话均可拨打。',
        en: '💡 Emergency calls are free, no area code needed, any phone works.',
        ru: '💡 Бесплатно с любого телефона.'
      }
    }
  ],
  faq: [
