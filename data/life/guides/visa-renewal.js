...
export default {
  ...
  preparation: { zh: ['护照', '在读证明', '成绩单', '体检报告（部分城市）'], en: ['Passport', 'Enrollment cert', 'Transcript', 'Medical report (some cities)'], ru: ['Паспорт', 'Справка об обучении', 'Транскрипт', 'Медсправка'] },
    steps: [
    {
      title: { zh: '📅 每年续签流程', en: 'Annual renewal', ru: 'Ежегодное продление' },
      desc: {
        zh: '📅 每年续签流程：\n1. 学校提前通知续签时间\n2. 准备在读证明、成绩单\n3. 部分城市需要重新体检\n4. 学校统一提交或自行到出入境办理\n5. 缴费（400-800元）\n6. 等待领取',
        ...
        ru: '📅 Ежегодное продление:\n1. Школа уведомит\n2. Справка, транскрипт\n3. Иногда — медосмотр\n4. Школа или лично\n5. 400-800 ¥'
      }
    },
    {
      title: { zh: '注意事项', en: 'Step 2', ru: 'Плохие оценки/посещаемость — проблемы. Смена вуза — заново.' },
      desc: {
        zh: '💡 注意事项：\n• 成绩不达标可能影响续签\n• 出勤率低于要求可能被拒\n• 换专业/学校需要重新办理',
        en: '💡 Notes: poor grades may affect renewal; low attendance may be rejected; changing major/school requires re-application.',
        ru: '💡 Плохие оценки/посещаемость — проблемы. Смена вуза — заново.'
      }
    }
  ],
  faq: [
