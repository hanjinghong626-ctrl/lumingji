...
export default {
  ...
  steps: [
    {
      title: { zh: '朋友圈与小程序', en: 'Moments & Mini-programs', ru: 'Моменты и мини-программы' },
      desc: { zh: '📸 朋友圈：\n• 类似Instagram/朋友圈\n• 分享照片、文字、链接\n• 可以点赞和评论\n• 注意：中国人很重视朋友圈形象\n\n📱 小程序：\n• 无需下载App即可使用各种服务\n• 搜索小程序或用朋友分享的链接\n• 常用：点餐、购物、打车、缴费\n• 下拉微信首页 → 最近使用的小程序\n\n💡 小程序可以替代很多App，节省手机空间', en: '📸 Moments: like Instagram, share photos/text/links, like and comment. Chinese people care about their Moments image.\n\n📱 Mini-programs: use services without downloading apps. Search or open shared links. Common: ordering, shopping, ride-hailing, utilities. Pull down WeChat homepage for recent mini-programs.\n💡 Mini-programs replace many apps, saving phone space.', ru: '📸 Моменты: как Instagram, фото/текст/ссылки. Китайцы заботятся о имидже.\n📱 Мини-программы: сервисы без скачивания. Поиск или ссылки. Потяните вниз для последних.\n💡 Заменяют многие приложения.' },
    },
  ],
  faq: [
