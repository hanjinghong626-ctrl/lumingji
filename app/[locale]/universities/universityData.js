...
export const universities = [
  {
    ...
    address: { zh: '青岛市崂山区松岭路23号', ru: '23 ул. Сунлин, район Лаошань', en: '23 Songling Rd, Laoshan District' },
    lat: 36.158, lng: 120.632,
    description: {
  ...
  },
  {
    ...
    address: { zh: '青岛市崂山区宁夏路308号', ru: '308 ул. Нинся, район Лаошань', en: '308 Ningxia Rd, Laoshan District' },
    lat: 36.104, lng: 120.414,
    description: {
