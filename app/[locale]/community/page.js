    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="card text-center group">
          ...
          <h3 className="text-lg font-serif font-bold text-gray-800 mb-2">{t('telegram')}</h3>
          <p className="text-sm text-gray-500 mb-4">{t('telegram_desc')}</p>
        ...
        <div className="card text-center group">
          ...
          <h3 className="text-lg font-serif font-bold text-gray-800 mb-2">{t('vk')}</h3>
          <p className="text-sm text-gray-500 mb-4">{t('vk_desc')}</p>
          <a href="#" className="btn-primary text-sm">
            {t('join_hint')}
          </a>
        </div>
        ...
        <div className="card text-center group">
          ...
          <h3 className="text-lg font-serif font-bold text-gray-800 mb-2">{t('wechat')}</h3>
          <p className="text-sm text-gray-500 mb-4">{t('wechat_desc')}</p>
          <a href="#" className="btn-primary text-sm">
            {t('join_hint')}
          </a>
        </div>
